...
-- state_out[2]	=>  Location: PIN_8,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL \dut_instance|add_instance|D~0_combout\ : std_logic;
...
-- Equation(s):
-- \datau[0]~1_combout\ = (\datau[0]~0_combout\ & (!\dut_instance|add_instance|ff1|Q~q\ & ((!\u0|virtual_jtag_0|sld_virtual_jtag_basic_inst|virtual_state_sdr~0_combout\)))) # (!\datau[0]~0_combout\ & (((datau(0)))))
...
-- Equation(s):
-- \dut_instance|add_instance|D~0_combout\ = (!\dut_instance|add_instance|ff1|Q~q\ & !\dut_instance|add_instance|ff2|Q~q\)
...
PORT MAP (
	...
	combout => \dut_instance|add_instance|D~0_combout\);
...
PORT MAP (
	...
	d => \dut_instance|add_instance|D~0_combout\,
...
-- Equation(s):
-- \dut_instance|add_instance|D\(2) = (\dut_instance|add_instance|ff1|Q~q\) # ((!\dut_instance|add_instance|ff2|Q~q\ & \dut_instance|add_instance|ff3|Q~q\))
...
\dut_instance|add_instance|D[0]\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \dut_instance|add_instance|D\(0) = (!\dut_instance|add_instance|ff3|Q~q\ & ((\dut_instance|add_instance|ff2|Q~q\) # (\dut_instance|add_instance|ff1|Q~q\)))
